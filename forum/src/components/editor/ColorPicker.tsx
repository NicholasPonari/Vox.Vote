...
export function ColorPickerComponent({
  ...
  const isFormEvent = (arg: unknown): arg is React.FormEvent<HTMLDivElement> => {
    return typeof arg === 'object' && arg !== null && 'preventDefault' in arg;
  };
 
  function handleCustomColorChange(event: React.FormEvent<HTMLDivElement>): void;
  function handleCustomColorChange(value: ColorLike): void;
  function handleCustomColorChange(arg: unknown): void {
    // If this is an event call signature, ignore it.
    if (isFormEvent(arg)) {
      return;
    }
        ...
        <Tabs defaultValue="preset" className="w-full">
          ...
          <TabsContent value="custom" className="space-y-3">
            ...
            <ShadcnColorPicker
              defaultValue="#3b82f6"
              onChange={
                handleCustomColorChange as unknown as React.FormEventHandler<HTMLDivElement> &
